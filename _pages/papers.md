...
* **Mod $\ell$ gamma factors and a converse theorem for finite general linear groups**, *J. Bakeberg, M. Gerbelli-Gauthier, H. Goodson, A. Iyengar, G. Moss, R. Zhang*.
...
* **Deformation Theory of the Trivial mod $p$ Galois Representation for $\mathrm{GL}_n$**, *A. Iyengar*.
